...
print("=== 병상 분배 최적화 모델 (병원 단위) - 수정본 ===")
print("📊 정수계획법을 사용한 병상 효율적 분배 시스템 (서울 포함)")
print()
...
results_dir = "optimization_results_병상_분배_최적화_병원기준_수정"
...
print("="*60)
print("🎯 병상 분배 최적화(병원 단위, 서울 포함) 완료!")
print("="*60) 