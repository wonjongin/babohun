...
if results:
    ...
    result_df.to_csv('analysis_data/병원별_진료과별_시계열예측결과_개선.csv', index=False, encoding='utf-8')
    print('저장 완료: analysis_data/병원별_진료과별_시계열예측결과_개선.csv')
...
'''
저장 완료: analysis_data/병원별_진료과별_시계열예측결과_개선.csv
...
ARIMA 모델:
  RMSE: 1851.7709 (n=120)
  MAE: 1851.7709 (n=120)
  MAPE: 1069.1985 (n=107)
  R2: 계산 불가
  Adjusted_R2: 계산 불가

RF 모델:
  RMSE: 2014.2417 (n=120)
  MAE: 2014.2417 (n=120)
  MAPE: 1173.2367 (n=107)
  R2: 계산 불가
  Adjusted_R2: 계산 불가

XGB 모델:
  RMSE: 1971.0708 (n=120)
  MAE: 1971.0708 (n=120)
  MAPE: 962.0155 (n=107)
  R2: 계산 불가
  Adjusted_R2: 계산 불가
...
..   ..         ...     ...
175  중앙        호스피스    8666
176  중앙  호스피스완화의료센터   18525
177  중앙  호흡기·알레르기내과   11115
178  중앙       호흡기내과  161632
179  중앙        흉부외과  133850
