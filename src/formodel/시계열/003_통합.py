...
result_df.to_csv('analysis_data/병원별_진료과별_입원외래_통합_시계열예측결과.csv', index=False, encoding='utf-8')
print('저장 완료: analysis_data/병원별_진료과별_입원외래_통합_시계열예측결과.csv')
...
'''
저장 완료: analysis_data/병원별_진료과별_입원외래_통합_시계열예측결과.csv
